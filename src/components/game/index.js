...
//Yellow
  ...
  function takeFlashLight() {
    ...
    innerCell.children[9].visible = false;
  ...
  function openBox() {
    ...
    // innerCell.addChild(boxOpened); // 8
    // innerCell.addChild(objects.flashLight); //9
    innerCell.children[8].visible = true;
    innerCell.children[9].visible = true;
    // //Ok, this needs
  }
